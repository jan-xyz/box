...
type SQSMessage struct {
	...
	//
	//	*SQSMessage_LowerCase
	//	*SQSMessage_UpperCase
	Message isSQSMessage_Message `protobuf_oneof:"message"`
}
...
func (m *SQSMessage) GetMessage() isSQSMessage_Message {
	if m != nil {
		return m.Message
	}
	return nil
...
func (x *SQSMessage) GetLowerCase() *LowerCase {
	if x, ok := x.GetMessage().(*SQSMessage_LowerCase); ok {
		return x.LowerCase
	}
	return nil
}

func (x *SQSMessage) GetUpperCase() *UpperCase {
	if x, ok := x.GetMessage().(*SQSMessage_UpperCase); ok {
		return x.UpperCase
	}
	return nil
}

type isSQSMessage_Message interface {
	isSQSMessage_Message()
}

type SQSMessage_LowerCase struct {
	LowerCase *LowerCase `protobuf:"bytes,1,opt,name=lower_case,json=lowerCase,proto3,oneof"`
}

type SQSMessage_UpperCase struct {
	UpperCase *UpperCase `protobuf:"bytes,2,opt,name=upper_case,json=upperCase,proto3,oneof"`
}

func (*SQSMessage_LowerCase) isSQSMessage_Message() {}

func (*SQSMessage_UpperCase) isSQSMessage_Message() {}
...
var file_strsvc_proto_rawDesc = []byte{
	...
	,
	...
	0x2f, 0x73, 0x74, 0x72, 0x73, 0x76, 0x63, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_strsvc_proto_goTypes = []interface{}{
	(*SQSMessage)(nil), // 0: strsvc.v1.SQSMessage
...
var file_strsvc_proto_depIdxs = []int32{
	1, // 0: strsvc.v1.SQSMessage.lower_case:type_name -> strsvc.v1.LowerCase
	2, // 1: strsvc.v1.SQSMessage.upper_case:type_name -> strsvc.v1.UpperCase
...
func file_strsvc_proto_init() {
	...
	file_strsvc_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*SQSMessage_LowerCase)(nil),
		(*SQSMessage_UpperCase)(nil),
	}
	type x struct{}
