...
var LoggingMiddleware = box.MiddlewareFunc[*strsvcv1.Request, *strsvcv1.Response](func(next box.Endpoint[*strsvcv1.Request, *strsvcv1.Response]) box.Endpoint[*strsvcv1.Request, *strsvcv1.Response] {
